...
def process(hexvalue):
	...
	gender_FCsum = bin(int(hexvalue[64],16))[2:].zfill(8)
	pokemon.fateful_encounter = hex(int(pokemon.gender_FCsum[27:], 2)).replace('0x',"")
	pokemon.female = hex(int(pokemon.gender_FCsum[27:], 2)).replace('0x',"")
	pokemon.genderless = hex(int(pokemon.gender_FCsum[27:], 2)).replace('0x',"")
